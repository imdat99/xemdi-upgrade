                ...
                <div className="head flex">
                    ...
                    <div className="head-guide">
                        <div className="head-promotion" ref={imgRef}>
                            <div className="left">
                                <a
                                    href="https://xemdi.app/"
                                    className="block Lazy"
                                    target="_blank"
                                    style={{
                                        backgroundImage:
                                            "url('/images/img-bj.png')",
                                    }}
                                >
                                    <img
                        ...
                        <div className="home-box border-shadow">
                            <div className="home-nav flex">
                                {menuList.filter(i => i.type == NavType.HomeNav).map((item, index) => (
